...
$result = mysqli_query($conn, "Select * from surat_masuk sm, jenis_surat js where sm.kode_id=js.id_jenis");
?>
<div class="container-fluid px-5">

    <div class="d-sm-flex align-item s-center justify-content-between mb-4 row">
        <h1 class="h3 mb-0 text-gray-800 col">Daftar Surat Masuk</h1>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="sm_edit.php?n_sm=<?= $row['id_sm'] ?>" class="btn btn-warning btn-circle btn-sm"><i class="fas fa-pen"></i></a>
                                    <a href="hapus.php?n_sm=<?= $row['id_sm'] ?>" class="btn btn-danger btn-circle btn-sm"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php $i++;
                        endwhile; ?>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="sm_add.php" method="POST" enctype="multipart/form-data">
